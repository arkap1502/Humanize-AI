...
const REPLACEMENTS = [
  ...
  // ---- Total-casual wave: stiff verbs -> everyday verbs ----
  ['initiating', 'starting'],
  ['initiates', 'starts'],
  ['initiated', 'started'],
  ['initiate', 'start'],
  ...
  ['pondering', 'mulling over'],
  ['ponders', 'mulls over'],
  ['pondered', 'mulled over'],
  ['ponder', 'mull over'],
  ['ruminate on', 'think about'],
  ['ruminates on', 'thinks about'],
  ['ruminated on', 'thought about'],
  ['ruminate', 'think'],
  ['vocalizing', 'voicing'],
  ['vocalizes', 'voices'],
  ['vocalized', 'voiced'],
  ['vocalize', 'voice'],
  ['expounds on', 'explains'],
  ['expound on', 'explain'],
  ['expounded on', 'explained'],
  ['recapitulating', 'recapping'],
  ['recapitulates', 'recaps'],
  ...
  ['denoted', 'showed'],
  ['denote', 'show'],
  ['connoting', 'suggesting'],
  ['connotes', 'suggests'],
  ['connoted', 'suggested'],
  ['connote', 'suggest'],
  ['inferring', 'figuring out'],
  ['infers', 'figures out'],
  ['inferred', 'figured out'],
  ['infer', 'figure out'],
  ['deducing', 'working out'],
  ['deduces', 'works out'],
  ['deduced', 'worked out'],
  ['deduce', 'work out'],
  ['extrapolating', 'predicting'],
  ['extrapolates', 'predicts'],
  ['extrapolated', 'predicted'],
  ['extrapolate', 'predict'],
  ['hypothesizing', 'guessing'],
  ['hypothesizes', 'guesses'],
  ['hypothesized', 'guessed'],
  ['hypothesize', 'guess'],
  ['theorizing', 'wondering about'],
  ['theorizes', 'wonders about'],
  ['theorized', 'wondered about'],
  ['theorize', 'wonder about'],
  ...
  // ---- Total-casual wave: stiff nouns/adjectives -> plain words ----
  ['persons', 'people'],
  ['personnel', 'staff'],
  ...
  ['entrees', 'mains'],
  ['confections', 'sweets'],
  ['synergy between', 'teamwork between'],
  ['have the bandwidth to', 'have time to'],
  ['no bandwidth for', 'no time for'],
  ['circle back to', 'get back to'],
  ...
  ['trepidatious', 'nervous'],
  ['wary of', 'careful about'],
  ['leery of', 'careful about'],
  ['skeptical of', 'unsure about'],
  ['skeptical about', 'unsure about'],
  ['dubious', 'doubtful'],

  // ---- Ultra-casual: spoken slang, Strong intensity only ----
  ['want to', 'wanna', 2],
  ['kind of', 'kinda', 2],
  ['sort of', 'sorta', 2],
  ['out of', 'outta', 2],
  ['have to', 'gotta', 2],
  ['have got to', 'gotta', 2],
  ['a lot of things', 'lots of stuff', 2],
  ['many things', 'lots of stuff', 2],
  ['ambiance', 'vibe', 2],
  ['ambience', 'vibe', 2],
  ['aura', 'vibe', 2],
